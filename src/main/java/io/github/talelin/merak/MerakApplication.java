package io.github.talelin.merak;
...
@RestController
public class MerakApplication {

    public static void main(String[] args) {
        SpringApplication.run(MerakApplication.class, args);
    }
    ...
    public String index() {
        return "<style type=\"text/css\">*{ padding: 0; margin: 0; } div{ padding: 4px 48px;} a{color:#2E5CD5;cursor:" +
                ...
                "Lin <br/><span style=\"font-size:30px\">bizzbee，林间有风。</span></p></div> ";
    }
}
